...
def run_gofher_with_parameters(name,fits_path_function,blue_to_red_bands_in_order,ref_band,inital_gofher_params,paper_label="",mode="fixed", s: int=None, bin_prior_to_param_fitting=False):
